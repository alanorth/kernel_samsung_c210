...
#ifndef __S5K5CCGX_P2_H__
#define __S5K5CCGX_P2_H__
...
enum s5k5ccgx_preview_frame_size {
	...
	S5K5CCGX_PREVIEW_736x552,	/* 736x552 */
...
struct s5k5ccgx_regs {
	...
	struct s5k5ccgx_regset_table preview_size[S5K5CCGX_PREVIEW_MAX];	/*Used */
	/* struct s5k5ccgx_regset_table capture_size[S5K5CCGX_CAPTURE_MAX];*/	/* Unused */
	...
	struct s5k5ccgx_regset_table jpeg_quality_high;
	struct s5k5ccgx_regset_table jpeg_quality_normal;
	struct s5k5ccgx_regset_table jpeg_quality_low;
	...
	struct s5k5ccgx_regset_table af_low_light_mode_on;
	struct s5k5ccgx_regset_table af_low_light_mode_off;
	...
	struct s5k5ccgx_regset_table ae_awb_lock_on; /* Unused */
	struct s5k5ccgx_regset_table ae_awb_lock_off; /* Unused */
	...
	struct s5k5ccgx_regset_table low_cap_on; /* Unused */
	struct s5k5ccgx_regset_table low_cap_off; /* Unused */
	struct s5k5ccgx_regset_table restore_cap;	/*Used */
	struct s5k5ccgx_regset_table change_wide_cap;	/* Used */
	...
	struct s5k5ccgx_regset_table single_af_off_1;
	struct s5k5ccgx_regset_table single_af_off_2;
	struct s5k5ccgx_regset_table dtp_start;
	struct s5k5ccgx_regset_table dtp_stop;
	struct s5k5ccgx_regset_table init_reg;	/* Used. */
	...
	struct s5k5ccgx_regset_table update_preview_setting; /* Used. */
	struct s5k5ccgx_regset_table stream_stop;	/* Used */
	struct s5k5ccgx_regset_table antibanding_50hz;
	struct s5k5ccgx_regset_table antibanding_60hz;
