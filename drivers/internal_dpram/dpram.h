...
#define DPRAM_MAGIC_CODE_ADDRESS \
	(DPRAM_START_ADDRESS)
#define DPRAM_ACCESS_ENABLE_ADDRESS \
	(DPRAM_START_ADDRESS + 0x0002)
...
#define DPRAM_PDA2PHONE_FORMATTED_BUFFER_SIZE	\
	(1020+1024)	/* 0x03FC */

#define DPRAM_PDA2PHONE_RAW_START_ADDRESS \
	(DPRAM_START_ADDRESS + 0x0404 + 1024)
...
#define DPRAM_PDA2PHONE_RAW_BUFFER_SIZE \
	(7152-1024)	/* 1BF0 */

#define DPRAM_PHONE2PDA_FORMATTED_START_ADDRESS \
	(DPRAM_START_ADDRESS + 0x1FF8)
#define DPRAM_PHONE2PDA_FORMATTED_HEAD_ADDRESS \
	(DPRAM_PHONE2PDA_FORMATTED_START_ADDRESS)
...
#define DPRAM_PHONE2PDA_FORMATTED_BUFFER_SIZE	\
	(1020+1024)	/* 0x03FC */

#define DPRAM_PHONE2PDA_RAW_START_ADDRESS \
	(DPRAM_START_ADDRESS + 0x23F8 + 1024)
#define DPRAM_PHONE2PDA_RAW_HEAD_ADDRESS \
	(DPRAM_PHONE2PDA_RAW_START_ADDRESS)
...
#define DPRAM_PHONE2PDA_RAW_BUFFER_SIZE \
	(7152-1024)	/* 1BF0 */

#define DPRAM_PDA2PHONE_INTERRUPT_ADDRESS	\
	(DPRAM_START_ADDRESS + 0x3FFC)
#define DPRAM_PHONE2PDA_INTERRUPT_ADDRESS	\
	(DPRAM_START_ADDRESS + 0x3FFE)

#define DPRAM_INTERRUPT_PORT_SIZE			2

#define DPRAM_START_ADDRESS_PHYS 	 		0x13A00000
...
#define INT_MASK_CMD_PDA_SLEEP	\
	0x000C  /* PDA Sleep Interrupt to Modem 0xCD */
#define INT_MASK_CMD_DPRAM_DOWN \
	0x000C  /* DPRAM_DOWN Interrupt from Modem 0xCB */
#define INT_MASK_CMD_PDA_WAKEUP \
	0x000A  /* PDA Wake up Interrupt to Modem 0xCC */
#define INT_MASK_CMD_CP_WAKEUP_START \
	0x000A  /* CP Send ack CE to PDA*/
...
#define DPRAM_TEST	_IO(IOC_SEC_MAGIC, 0xcf) /* TODO:Dummy for now */
#define DPRAM_CP_CRASH	_IO(IOC_SEC_MAGIC, 0xca)
