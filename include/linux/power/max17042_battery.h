...
#elif defined(CONFIG_MACH_P4W_REV00) || defined(CONFIG_MACH_P4W_REV01)		/* P4W battery parameter */
...
#define CURRENT_RANGE_MAX	CURRENT_RANGE4
#define CURRENT_RANGE_MAX_NUM	4	/* added as dummy value to fix build error */
/* SDI type low battery compensation offset */
