...
#define S3C_VENDOR_ID		0x04e8
#define S3C_PRODUCT_ID		0x6860 /* devguru host driver : mtp + ... */
...
static char *usb_functions_acm[] = { "mtp", "acm"};
static char *usb_functions_acm_adb[] = { "mtp", "acm", "adb"};
#endif
#ifdef CONFIG_USB_ANDROID_DIAG
static char *usb_functions_acm_diag_adb[] = { "mtp", "acm", "diag", "adb" };
static char *usb_functions_rndis_diag_adb[] = { "rndis", "diag", "adb" };
#endif
...
static struct android_usb_product usb_products[] = {
...
#ifdef CONFIG_USB_ANDROID_DIAG
	{
		.vendor_id      = S3C_VENDOR_ID,
		.product_id     = 0x6860,
		.num_functions  = ARRAY_SIZE(usb_functions_acm_diag_adb),
		.functions      = usb_functions_acm_diag_adb,
	},
	{
		.vendor_id      = S3C_VENDOR_ID,
		.product_id     = 0x6864,
		.num_functions  = ARRAY_SIZE(usb_functions_rndis_diag_adb),
		.functions      = usb_functions_rndis_diag_adb,
	},
#endif
#endif
	{
